...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
        ...
        //Student code goes here ...
                ...
                }else if ((grid[0][0] == grid[1][0]) && (grid[2][0] == grid[1][0])) {
                    if (grid[1][0] == 'o'){
                        result = "O wins";
                        System.out.println(result);
                    } else if (grid[1][0] == 'x') {
                ...
                }else if ((grid[0][0] == grid[1][1]) && (grid[2][2] == grid[1][1])) {
                    if (grid[2][2] == 'o'){
                        result = "O wins";
                        System.out.println(result);
                    } else if (grid[2][2] == 'x') {
                ...
                } else if ((grid[0][1] == grid[1][1] ) && (grid[2][1] == grid[1][1])) {
                    if (grid[0][1] == 'o') {
                        result = "O wins";
                        System.out.println(result);
                    } else if (grid[0][1] == 'x') {
                ...
                } else if ((grid[0][2] == grid[1][2] ) && (grid[2][2] == grid[1][2])) {
                    if (grid[0][2] == 'o') {
                        result = "O wins";
                        System.out.println(result);
                    } else if (grid[0][2] == 'x') {
                ...
                if ((allUsedFields == 9) && !(result.contains("win"))) {
                    result = "Tie";
                }
        return result;
    }
